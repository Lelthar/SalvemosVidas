...
class ForumPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum_post" do
    assert_difference('ForumPost.count') do
      post forum_posts_url, params: { forum_post: { category: @forum_post.category, datail: @forum_post.datail, title: @forum_post.title, user_id: @forum_post.user_id } }
    end
  ...
  test "should update forum_post" do
    patch forum_post_url(@forum_post), params: { forum_post: { category: @forum_post.category, datail: @forum_post.datail, title: @forum_post.title, user_id: @forum_post.user_id } }
