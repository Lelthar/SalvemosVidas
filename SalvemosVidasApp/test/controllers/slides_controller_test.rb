...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post slides_url, params: { slide: { lesson_id: @slide.lesson_id, title: @slide.title, type: @slide.type } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { lesson_id: @slide.lesson_id, title: @slide.title, type: @slide.type } }
