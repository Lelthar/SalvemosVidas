...
class CommentariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commentary" do
    assert_difference('Commentary.count') do
      post commentaries_url, params: { commentary: { datail: @commentary.datail, forum_post_id: @commentary.forum_post_id, user_id: @commentary.user_id } }
    end
  ...
  test "should update commentary" do
    patch commentary_url(@commentary), params: { commentary: { datail: @commentary.datail, forum_post_id: @commentary.forum_post_id, user_id: @commentary.user_id } }
