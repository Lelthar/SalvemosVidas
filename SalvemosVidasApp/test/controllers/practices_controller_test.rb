...
class PracticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post practices_url, params: { practice: { category: @practice.category, description: @practice.description, lesson_id: @practice.lesson_id, title: @practice.title } }
    end
  ...
  test "should update practice" do
    patch practice_url(@practice), params: { practice: { category: @practice.category, description: @practice.description, lesson_id: @practice.lesson_id, title: @practice.title } }
