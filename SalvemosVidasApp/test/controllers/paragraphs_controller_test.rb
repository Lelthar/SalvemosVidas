...
class ParagraphsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paragraph" do
    assert_difference('Paragraph.count') do
      post paragraphs_url, params: { paragraph: { information: @paragraph.information, slide_id: @paragraph.slide_id } }
    end
  ...
  test "should update paragraph" do
    patch paragraph_url(@paragraph), params: { paragraph: { information: @paragraph.information, slide_id: @paragraph.slide_id } }
