class QuestionsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @question.update(question_params)
        format.html { redirect_to new_question_path(practice_id: @question.practice_id), notice: 'Question was successfully updated.' }
  ...
  def destroy
    @question.destroy
    respond_to do |format|
      format.html { redirect_to new_question_path(practice_id: @question.practice_id), notice: 'Question was successfully destroyed.' }
